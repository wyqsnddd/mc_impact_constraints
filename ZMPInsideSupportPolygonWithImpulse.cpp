...
namespace mc_impact{
  ...
  ZMPInsideSupportPolygonWithImpulse(const mc_solver::QPSolver & solver,
                                     ...
                                     mi_impactPredictor & predictor): InequalityConstraint(leftSoleContact.contactId(solver.robots()), 
					     rightSoleContact.contactId(solver.robots())
...
b_ = A_s*(predictor_.getImpulsiveForceCOM("l_sole").vector() 
		+ predictor_.getImpulsiveForceCOM("r_sole").vector()
